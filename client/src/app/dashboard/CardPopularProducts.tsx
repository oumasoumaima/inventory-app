  ...
  return (
    <div className="row-span-3 xl:row-span-6 glass-panel rounded-2xl pb-16">
      {isLoading ? (
        ...
        <>
          <h3 className="text-lg font-semibold px-7 pt-5 pb-2 text-gray-100">
            Popular Products
          </h3>
          ...
          <div className="overflow-auto h-full">
            {dashboardMetrics?.popularProducts.map((product) => (
              <div
                ...
                className="flex items-center justify-between gap-3 px-5 py-7 border-b border-gray-700"
              >
                <div className="flex items-center gap-3">
                  <Image
                    src={`https://placehold.co/50x50/3b82f6/ffffff.png?text=${product.name.substring(0, 3)}`}
                    alt={product.name}
                    width={48}
                    height={48}
